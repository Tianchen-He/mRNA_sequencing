...
theo_5_deH2O = theo_creater(df, theo_5, -H2O, "dehydrated 5'", 100, TRUE)
#theo_5_H2O = theo_creater(df, theo_5, H2O, "hydrated 5'", 90, TRUE)

theo_3_deH2O = theo_creater(df, theo_3, -H2O, "dehydrated 3'", 100, TRUE)
# theo_3_H2O = theo_creater(df, theo_3, H2O, "hydrated 3'", 85, FALSE)

new_theo_5 = theo_creater(df, theo_5, 0, "native 5'", 100, TRUE)
new_theo_3 = theo_creater(df, theo_3, 0, "native 3'", 100, FALSE)
...
palette = df %>% 
  ...
  drop_na() %>% 
  filter(ladder_type %in% c("native 3'","dehydrated 3'"), apex_rt<=20)
