...
<<<<<<< HEAD
set_up("mRNA", "GGGAAAUAAGAGAGAAAAG", "Data/Pure_AD/NistmRNA_15min_1st_Mistake_251010_JYL.xlsx", "peptide", 330000, 0, 30)
=======
...
>>>>>>> f8975128f662f5f1d675ba2005c5298a902a90a4
```
...
theo_5_deH2O = theo_creater(df, theo_5, -H2O, "dehydrated 5'", 19, TRUE)
#theo_5_H2O = theo_creater(df, theo_5, H2O, "hydrated 5'", 53, TRUE)

theo_3_deH2O = theo_creater(df, theo_3, -H2O, "dehydrated 3'", 19, FALSE)
#theo_3_H2O = theo_creater(df, theo_3, H2O, "hydrated 3'", 85, FALSE)

new_theo_5 = theo_creater(df, theo_5, 0, "native 5'", 19, TRUE)
new_theo_3 = theo_creater(df, theo_3, 0, "native 3'", 19, FALSE)
...
palette = df %>% 
  ...
  drop_na() %>% 
  filter(ladder_type %in% c("native 5'"), apex_rt<=20)
...
## Convert for excel denovo assembly 
