...
set_up("mRNA", "ACUCCUCUGGAUCUACUGGGUUACCUAAGGGUGUGGCCCUUCCGCAUAGAACUGCCUGCGUCAGAUUCUCGCAUGCCAGAGAUCCUAUUUUUGGCAAUC", "Data/Enzyme_AD/FlucmRNA_NIST_MazF1FA20min_T01_251023_SG_xiaohong_new.xlsx", "peptide", 330000, 0, 21)
```
...
theo_5_deH2O = theo_creater(df, theo_5, -H2O, "dehydrated 5'", 81, TRUE)
#theo_5_H2O = theo_creater(df, theo_5, H2O, "hydrated 5'", 90, TRUE)

theo_3_deH2O = theo_creater(df, theo_3, -H2O, "dehydrated 3'", 81, TRUE)
# theo_3_H2O = theo_creater(df, theo_3, H2O, "hydrated 3'", 85, FALSE)

new_theo_5 = theo_creater(df, theo_5, 0, "native 5'", 81, TRUE)
new_theo_3 = theo_creater(df, theo_3, 0, "native 3'", 81, FALSE)
...
palette = df %>% 
  ...
  drop_na() %>% 
  filter(ladder_type %in% c("native 5'","dehydrated 5'"), apex_rt<=20)
