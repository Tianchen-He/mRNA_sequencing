...
```{r}
exp <- read_xlsx("Data/MazF_1st/Fluc_mRNA_MazFalone_251021_test_251107.xlsx") %>% 
  janitor::clean_names() %>% 
  drop_na() %>% 
...
```{r}
df_comp <- find_compositions_ppm(target_mass = 12672, tolerance = 20, max_methyl = 0, max_length = 120)
```
